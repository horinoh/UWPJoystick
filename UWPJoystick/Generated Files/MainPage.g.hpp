...
void ::UWPJoystick::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::UWPJoystick::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::UWPJoystick::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
